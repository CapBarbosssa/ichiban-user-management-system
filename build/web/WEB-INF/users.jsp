...
<!--                     <a href="login">Log out</a>-->
                        ...
                        <tbody>
                            <c:forEach var="user1" items="${userList}">
                                <tr>
                                    ...
                                    <td>${user1.role.roleId}</td>
                                    <td>${user1.active ? "Y" : "N"}</td>
                                    <td>
                                        <a href="user?action=edit&email=${user1.email}">Edit</a>
                                        <a href="user?action=delete&email=${user1.email}">Delete</a>
                ...
                <div>
                  <a href="user?action=add" class="btn btn-primary active" aria-current="page">Add New User</a>
 
                  <a href="category"  class="btn btn-primary">View Item Category</a>

                   <a href="report" class="btn btn-primary" >Report To Excel</a>
